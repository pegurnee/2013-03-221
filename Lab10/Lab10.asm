...
START
LD R3, ORIGINAL	;load data at ORIGINAL to R3 (data edit)
...
VALIDATE_DIGIT
	...
	; R1 = the Post-condition notifier	
		ST R7, VALD_saveR7	; stores the PC+1 address (that is in R7) to VAL_saveR7
		ST R0, VALD_saveR0	;
		...
		VALD_Invalid
			ADD R1, R1, 1		; adds 1 to R5 to set invalid condition
			
		VALD_End
			LD R0, VALD_saveR0	; reloads whatever was in R1
